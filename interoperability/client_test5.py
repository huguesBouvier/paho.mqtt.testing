...
class Test(unittest.TestCase):
    ...
    def test_offline_message_queueing(self):
      print("\nOffline message queueing test starting")
      ...
      self.assertTrue(len(callback.messages) in [1, 2], len(callback.messages))
    ...
    def test_overlapping_subscriptions(self):
      ...
      if len(callback.messages) == 1:
        ...
        self.assertTrue((callback.messages[0][2] == 1 and callback.messages[1][2] == 1) or \
...
#      return succeeded
    ...
    def test_session_expiry(self):
      ...
      disconnect_properties.SessionExpiryInterval = 10
    ...
    def test_publication_expiry(self):
      print("\nPublication expiry test starting")
      callback.clear()
      callback2.clear()
      connect_properties = MQTTV5.Properties(MQTTV5.PacketTypes.CONNECT)
      connect_properties.SessionExpiryInterval = 99999
      ...
      publish_properties = MQTTV5.Properties(MQTTV5.PacketTypes.PUBLISH)
      for i in range(1000):
        aclient.publish(topics[0], b"qos 1 - inflight", 1, retained=False, properties=publish_properties)
      ...
      publish_properties.MessageExpiryInterval = 10
      ...
      time.sleep(1)
      self.assertEqual(len(callback2.messages), 1001, callback2.messages)
      self.assertTrue(callback2.messages[1000][5].MessageExpiryInterval < 10,
                             callback2.messages[1000][5].MessageExpiryInterval)
      aclient.disconnect()
    ...
    def test_subscribe_options(self):
      print("\nSubscribe options test starting")
      callback.clear()
      callback2.clear()
...
#      callback2.clear()
    ...
    def test_assigned_clientid(self):
      print("\nAssigned clientid test starting")
...
#      print("\nSubscribe identifiers test starting")
#      callback.clear()
#      callback2.clear()
#
#      aclient.connect(host=host, port=port, cleanstart=True)
...
#      callback2.clear()
    ...
    def test_request_response(self):
      print("\nRequest response test starting")
      callback.clear()
      callback2.clear()
...
#      print("\nClient topic alias test starting")
#      callback.clear()
#
...
#      print("\nServer topic alias test starting")
#      callback.clear()
#
...
#      print("\nMaximum packet size test starting")
#      callback.clear()
#
...
#      print("serverMaximumPacketSize: ", serverMaximumPacketSize)
...
#      print("\nServer keep alive test starting")
#      callback.clear()
#
...
#      aclient.disconnect()
    ...
    def test_flow_control1(self):
      ...
      serverReceiveMaximum = 16 # the default
...
#                       testcallback.disconnects[0]["reasonCode"].value)
    ...
    def test_shared_subscriptions(self):
      print("\nShared subscriptions test starting")
